...
export interface ShieldInterface extends utils.Interface {
  functions: {
    "HALVING_PERIOD()": FunctionFragment;
    "INITIAL_MINTABLE_PER_PERIOD()": FunctionFragment;
    ...
    "currentMintCap()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "INITIAL_MINTABLE_PER_PERIOD",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "currentMintCap",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Shield extends BaseContract {
  ...
  functions: {
    HALVING_PERIOD(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    currentMintCap(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  INITIAL_MINTABLE_PER_PERIOD(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    HALVING_PERIOD(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    currentMintCap(overrides?: CallOverrides): Promise<PopulatedTransaction>;
